...
export default function Header({ theme, setTheme }) {
  ...
  return (
    <header
      ...
      } z-10 shadow-md fixed top-0 right-0 left-0 w-full`}
    >
      <div className="navbar px-4 py-3 flex justify-between items-center">
        <div className="flex-1">
          <p className="text-xl font-bold sm:text-2xl">Where in the world?</p>
        </div>
        <div className="flex-none">
          <button
            ...
            className={`${
              theme ? "bg-gray-800 text-white" : "bg-white text-black"
            } btn border-none px-4 py-2 sm:px-6 sm:py-3`}
          >
            <label className="swap swap-rotate text-xs sm:text-base">
